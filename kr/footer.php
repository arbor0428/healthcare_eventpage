					...
					<div class="f_center">
						<div class="f_top dp_f dp_c">
							...
							<div class="f_info_box dp_f">
								<a class="policy_go_btn c_wht" href="./PrivacyPolicy.php" title="개인정보처리방침">개인정보처리방침</a>
								<div class="company_wrap">
									<p class="c_wht">롯데헬스케어 주식회사</p>
									<p class="c_wht">주소 : 서울특별시 송파구 올림픽로 300 롯데월드타워 30층</p>
									<div class="basic_info_wrap dp_f">
										<div class="basic_info">
											<p>대표이사 : 이훈기</p>
											<p class="mobile_flex">
												<span>연락처 : </span>
												<span>(전화번호) 02-3431-8102 <br class='mobileChk'>(이메일) lottehealthcare@lotte.net</span>
											</p>
										</div><!-- 
										<div class="basic_info">
											<p>+82-2-3431-8102</p>
