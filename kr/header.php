   ...
   <form name='frm011' method='post' action='/kr/sub01/sub02.php'>
<input type="text" style="display: none;">  <!-- 텍스트박스 1개이상 처리.. 자동전송방지 -->
<input type='hidden' name='type' value=''>
<input type='hidden' name='uid' value=''>
<input type='hidden' name='record_start' value='0'>
<input type="hidden" name="table_id" value="table_1672035767" autocomplete="off">
<input type="hidden" name="next_url" value="/kr/sub01/sub02.php" autocomplete="off">
<input type="hidden" name="strRoot" value="../" autocomplete="off">
<input type="hidden" name="boardRoot" value="../../board/" autocomplete="off">
</form>
		<a href="javascript:;" onclick="main_reg_view('23', '5')" class="topbanner">최근 이슈에 대한 공식입장</a>
   ...
   function main_reg_view(uid){
	form = document.frm011;
	form.type.value = 'view';
	form.uid.value = uid;
	form.action = '/kr/sub01/sub02.php';
	form.submit();
}
