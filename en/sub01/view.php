    ...
    <div class="view_visual">
        <div class="view_content_wrap nopadd">
            <p class="vv_tit01 dp_f dp_c c_wht">
                <span class="c_wht">2022.12.07</span>
                <span class="s_bar"></span>
                <span class="c_wht">Newsroom</span>
            </p>
            <p class="vv_tit02 c_wht montserrat bold2">Please enter a news title.</p>
        </div>
    </div>
    <div class="view_content_wrap">
        <a class="goback_btn dp_f dp_c" href="./list.php">
            <img src="/images/sub01/list_go_back.png" alt="">
            <span class="c_blk01">BACK</span>
        </a>
        ...
        <div class="bora_content_box">
            <ul>
                <li>· Enter news content. Enter news content. Enter news content. Enter news content.</li>
                <li>· Enter news content. Enter news content. Enter news content. Enter news content.</li>
            </ul>
        </div>
        <div class="view_content_text">
            <p class="view_content_date c_blk01 bold2">December 08, 2022</p>
            <p class="c_blk02">
        ...
        <a class="red01 c_wht list_page_btn dp_sb dp_c" href="./list.php">
            <span>Newsroom</span>
